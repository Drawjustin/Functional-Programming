...
public class PrimitiveStreamMain {
    public static void main(String[] args) {
        ...
        System.out.println("합계: " + intSummaryStatistics.getSum());
        System.out.println("평균: " + intSummaryStatistics.getAverage());
        System.out.println("최대값: " + intSummaryStatistics.getMax());
        System.out.println("최소값: " + intSummaryStatistics.getMin());
        System.out.println("개수: " + intSummaryStatistics.getCount());
