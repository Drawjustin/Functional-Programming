...
public class AddressMain2 {
    ...
    private static void printStreet(User user1) {
        Optional<String> userStreet = getUserStreet(user1);
        userStreet.ifPresentOrElse(System.out::println,() -> System.out.println("Unknown"));
    }
